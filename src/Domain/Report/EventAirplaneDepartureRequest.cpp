...
EventAirplaneDepartureRequest::EventAirplaneDepartureRequest(time_t eventTimeValue, std::string vAirplaneName, std::string vAirplaneAirline) : Events(eventTimeValue)
{
